...
<div className="hidden lg:flex items-center justify-center bg-base-200 p-10">
  <div className="text-center max-w-md space-y-6">
    ...
    />
    <h2 className="text-3xl font-bold ">Welcome back to Chit Chat!</h2>
    <p className="text-base text-base-content/60">
      Connect instantly, chat freely, and enjoy seamless conversations with friends and colleagues.
    </p>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
                ...
                <img src="/logo.png" alt="logo" className='w-32 md:hidden'/>
